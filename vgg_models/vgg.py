...
'''
source code : https://github.com/PKU-IMRE/FHDe2Net/blob/main/model/vgg.py
'''
...
class my_VGG19(nn.Module):
    ...
    def forward(self, input_images):
        ...
        # input_images = (input_images - self.mean) / self.std
        feature = {}
        conv1_1 = self.conv1_1(input_images)
        feature['conv1_1'] = conv1_1
        conv1_2 = self.conv1_2(conv1_1)
        feature['conv1_2'] = conv1_2
        pool1 = self.pool1(conv1_2)
        feature['pool1'] = pool1
        conv2_1 = self.conv2_1(pool1)
        feature['conv2_1'] = conv2_1
        conv2_2 = self.conv2_2(conv2_1)
        feature['conv2_2'] = conv2_2
        pool2 = self.pool2(conv2_2)
        feature['pool2'] = pool2
        conv3_1 = self.conv3_1(pool2)
        feature['conv3_1'] = conv3_1
        conv3_2 = self.conv3_2(conv3_1)
        feature['conv3_2'] = conv3_2
        conv3_3 = self.conv3_3(conv3_2)
        feature['conv3_3'] = conv3_3
        conv3_4 = self.conv3_4(conv3_3)
        feature['conv3_4'] = conv3_4
        pool3 = self.pool3(conv3_4)
        feature['pool3'] = pool3
        conv4_1 = self.conv4_1(pool3)
        conv4_2 = self.conv4_2(conv4_1) 
        feature['conv4_1'] = conv4_1
        feature['conv4_2'] = conv4_2
